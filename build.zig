...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "kline" is the name you will use in your source code to
                // import this module (e.g. `@import("kline")`). The name is
    ...
    // Example: Triangle rendering demo
    ...
    const triangle_run_step = b.step("triangle", "Run the triangle example");
